...
<span style="#455A45"><h3>Before Web Audio API there was the HTML audio element</h3></span>
...
###<span style="color:#455A45">The goal of Web Audio API</span>
...
###<span style="color:#455A45">Let's get started!</span>

- #####<span style="color:#455A45">Making sound in the browser</span> 
...
#####<span style="color:#CAA24E">References</span>
